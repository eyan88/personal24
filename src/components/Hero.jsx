...
export default function Hero() {
  ...
  return (
    <motion.section
      id="hero"
      className="h-screen relative pt-24 md:pt-48 md:px-16 items-center justify-center">
      <div className="relative">
        ...
        <h1 className="relative flex flex-col text-display md:leading-snug font-sentient font-medium text-tertiary-100 px-6 md:px-24">
            <motion.span
